...
For a demo of the capabilities of `markyp-rss`, head over to the project's [GitHub Pages](volfpeter.github.io/markyp-bootstrap4). The source code of that page was generated by the `demo.py` script that you can find at the root of this repository.
